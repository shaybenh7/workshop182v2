        ...
        $(document).ready(function () {
            ...
            jQuery.ajax({
                ...
                success: function (response) {
                    ...
                    string += "<div class=\"wrap-num-product flex-w m-r-20 m-tb-10\">";
                    string += "<div class=\"btn-num-product-down cl8 hov-btn3 trans-04 flex-c-m\">";
                    string += "<i class=\"fs-16 zmdi zmdi-minus\"></i>";
                    string += "</div>";
                    string += "<input class=\"mtext-104 cl3 txt-center num-product\" type=\"number\" id=\"num-product\" name=\"num-product\" value=\"1\">";
                    string += "<div class=\"btn-num-product-up cl8 hov-btn3 trans-04 flex-c-m\">";
                    string += "<i class=\"fs-16 zmdi zmdi-plus\"></i>";
                    string += "</div>";
                    string += "</div>";
